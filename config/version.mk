...
ifeq ($(DERP_BUILDTYPE), CI)
    AOSIP_VERSION := $(AOSIP_BUILD_VERSION)-$(DERP_BUILDTYPE)-$(AOSIP_BUILD)-$(shell date -u +%Y%m%d-%H%M)-$(DERP_BUILD_ZIP_TYPE)
endif

ifndef AOSIP_VERSION
    AOSIP_VERSION := $(AOSIP_BUILD_VERSION)-$(DERP_BUILDTYPE)-$(AOSIP_BUILD)-$(BUILD_DATE)-$(DERP_BUILD_ZIP_TYPE)
endif
