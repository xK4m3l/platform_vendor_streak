...
ALARM_PATH := vendor/streak/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/streak/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/streak/prebuilt/common/media/audio/ringtones
